...
const PopUpPerangkat = () => {
  ...
  return (
    <div className="">
         <div className={`bg-white w-[363px] h-[312px] rounded-md border shadow-2xl absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-30 animate__animated animate__fadeIn ${state.actionHapusPerangkat ? "" : "hidden"}`}>
