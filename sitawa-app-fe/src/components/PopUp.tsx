...
const PopUp = () => {
  ...
  return (
    <div >
         <div className={`bg-white w-[363px] h-[312px] rounded-md border shadow-2xl absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 ${isClose ? "hidden" : ""}`}>
        <div className="flex justify-end p-2">
          <button onClick={() => setClose(!isClose)} type="button">
            <span>
              <svg
                width="24px"
                height="24px"
