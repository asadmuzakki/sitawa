    ...
    <div>
        ...
        <div className="pt-36">
          <div className="w-[290px] ">
            <div onClick={() => navigate('/')} className={`flex items-center gap-3 mb-5 ${bg} w-[273px]  h-[54px] rounded-r-[50px] cursor-pointer`}>
            ...
            {/* icon 3 ------- */}
            <div onClick={() => navigate('/perangkat-desa')} className="flex items-center gap-3 mb-5 w-[273px] h-[54px] rounded-r-[50px] cursor-pointer">
              ...
              <p className="text-[#858585] text-[12px] mr-7">Perangkat Desa</p>
              {/* icon 4 ------- */}
            </div>
