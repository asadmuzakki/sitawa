...
const pengaduan = () => {
  ...
  return (
    <div className="relative ">
      <div
        className={`w-full h-full absolute ${state.actionAddData ? "bg-black opacity-50 z-20" : ""
          }`}
      ></div>
      <NavPengaduan />
      <div
        className={`relative h-[100vh] ${state.actionAddData ? "overflow-hidden" : ""
          }`}
      >
        <div>
          <AddPopUp />
        ...
        <div className="flex justify-center overflow-auto scrollbar-hide relative">
          <div className="tabel-pengaduan w-[76.875rem]   border border-[#f0f0f0] rounded-xl shadow-xl my-32">
            ...
            <form onSubmit={addPengaduan} className="w-full" action="">
              <div className="flex justify-center items-center text-[12px]">
                <div className="mt-5">
                  <div className="flex w-full  relative">
                    ...
                    <p
                      className={`p absolute right-0 mr-5 text-red-600 ${toggleInput && name === "" ? "block" : "hidden"
                        }`}
                    >
              ...
              <div className="flex justify-center items-center text-[12px]">
                <div className="mt-5">
                  <div className="flex w-full  relative">
                    ...
                    <p
                      className={`p absolute right-0 mr-5 text-red-600 ${toggleInput && phone_number === "" ? "block" : "hidden"
                        }`}
                    >
                      *Field tidak boleh kosong
                    </p>
              ...
              <div className="flex justify-center items-center text-[12px]">
                <div className="mt-5">
                  <div className="flex w-full  relative">
                    ...
                    <p
                      className={`p absolute right-0 mr-5 text-red-600 ${toggleInput && address === "" ? "block" : "hidden"
                        }`}
                    >
                      *Field tidak boleh kosong
                    </p>
                  ...
                  <div className="flex gap-3 mt-2 items-center">
                    <button
                      onClick={getLocation}
                      disabled={loading}
                      className={`lokasi-text py-1 px-2 rounded-lg  bg-custom-gradient text-white ${loading ? "hidden" : ""
                        }`}
                    >
                      Lokasi Saya
                    </button>
                    <div
                      className={`flex justify-center items-center gap-3  ${loading ? "" : "hidden"
                        }`}
                    >
              ...
              <div
                className={`flex justify-center mt-5 ${imageName === "" ? "hidden" : ""
                  } `}
              >
                <div className="input-pengaduan border border-[#f0f0f0] rounded-xl w-[950px] h-[116px] relative ">
                  ...
                  <div className=" ">
                    ...
                    <div
                      className={`mx-3 flex items-center gap-2 ${uploading ? "" : "hidden"
                        }`}
                    >
                      <div className="loader"></div>
              ...
              <div className="flex justify-center items-center text-[12px]">
                <div className="mt-5">
                  <div className="flex w-full  relative">
                    ...
                    <p
                      className={`p absolute right-0 mr-5 text-red-600 ${toggleInput && subject === "" ? "block" : "hidden"
                        }`}
                    >
                      *Field tidak boleh kosong
                    </p>
              ...
              <div className="flex justify-center items-center text-[12px]">
                <div className="mt-5">
                  <div className="flex w-full  relative">
                    ...
                    <p
                      className={`p absolute right-0 mr-5 text-red-600 ${toggleInput && description === "" ? "block" : "hidden"
                        }`}
                    >
                      *Field tidak boleh kosong
                    </p>
